...
fn attach_delegation<CTX: ContextTr<Block: FoundryBlock, Db: DatabaseExt>>(
    ccx: &mut CheatsCtxt<'_, CTX>,
...
fn sign_delegation<CTX: ContextTr<Block: FoundryBlock, Db: DatabaseExt>>(
    ccx: &mut CheatsCtxt<'_, CTX>,
...
fn broadcast<CTX: ContextTr<Block: FoundryBlock, Journal: JournalExt, Db: DatabaseExt>>(
    ccx: &mut CheatsCtxt<'_, CTX>,
...
fn broadcast_key<CTX: ContextTr<Block: FoundryBlock, Journal: JournalExt, Db: DatabaseExt>>(
    ccx: &mut CheatsCtxt<'_, CTX>,
    private_key: &U256,
    single_call: bool,
) -> Result {
