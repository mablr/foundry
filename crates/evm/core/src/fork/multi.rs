...
#[derive(Clone, Debug)]
#[must_use]
pub struct MultiFork<N: Network = AnyNetwork> {
...
enum ForkTask<N: Network = AnyNetwork> {
...
pub struct MultiForkHandler<N: Network = AnyNetwork> {
...
#[derive(Debug, Clone)]
struct CreatedFork<N: Network = AnyNetwork> {
...
/// instance.
#[derive(Debug)]
struct ShutDownMultiFork<N: Network = AnyNetwork> {
