...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for broadcast_0Call {
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for broadcast_1Call {
    fn apply_stateful(&self, ccx: &mut CheatsCtxt<'_, CTX, N>) -> Result {
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for broadcast_2Call {
    fn apply_stateful(&self, ccx: &mut CheatsCtxt<'_, CTX, N>) -> Result {
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for attachDelegation_0Call {
    fn apply_stateful(&self, ccx: &mut CheatsCtxt<'_, CTX, N>) -> Result {
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for attachDelegation_1Call {
    fn apply_stateful(&self, ccx: &mut CheatsCtxt<'_, CTX, N>) -> Result {
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for signDelegation_0Call {
    fn apply_stateful(&self, ccx: &mut CheatsCtxt<'_, CTX, N>) -> Result {
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for signDelegation_1Call {
    fn apply_stateful(&self, ccx: &mut CheatsCtxt<'_, CTX, N>) -> Result {
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for signDelegation_2Call {
    fn apply_stateful(&self, ccx: &mut CheatsCtxt<'_, CTX, N>) -> Result {
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for signAndAttachDelegation_0Call {
    fn apply_stateful(&self, ccx: &mut CheatsCtxt<'_, CTX, N>) -> Result {
        let Self { implementation, privateKey } = *self;
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for signAndAttachDelegation_1Call {
    fn apply_stateful(&self, ccx: &mut CheatsCtxt<'_, CTX, N>) -> Result {
        let Self { implementation, privateKey, nonce } = *self;
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for signAndAttachDelegation_2Call {
    fn apply_stateful(&self, ccx: &mut CheatsCtxt<'_, CTX, N>) -> Result {
        let Self { implementation, privateKey, crossChain } = *self;
...
fn attach_delegation<CTX: EthCheatCtx, N: Network>(
...
fn sign_delegation<CTX: EthCheatCtx, N: Network>(
    ccx: &mut CheatsCtxt<'_, CTX, N>,
...
fn write_delegation<CTX: EthCheatCtx, N: Network>(
    ccx: &mut CheatsCtxt<'_, CTX, N>,
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for attachBlobCall {
    fn apply_stateful(&self, ccx: &mut CheatsCtxt<'_, CTX, N>) -> Result {
        let Self { blob } = self;
        ensure!(
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for startBroadcast_0Call {
    fn apply_stateful(&self, ccx: &mut CheatsCtxt<'_, CTX, N>) -> Result {
        let Self {} = self;
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for startBroadcast_1Call {
    fn apply_stateful(&self, ccx: &mut CheatsCtxt<'_, CTX, N>) -> Result {
        let Self { signer } = self;
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for startBroadcast_2Call {
    fn apply_stateful(&self, ccx: &mut CheatsCtxt<'_, CTX, N>) -> Result {
        let Self { privateKey } = self;
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for stopBroadcastCall {
    fn apply_stateful(&self, ccx: &mut CheatsCtxt<'_, CTX, N>) -> Result {
        let Self {} = self;
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for getWalletsCall {
    fn apply_stateful(&self, ccx: &mut CheatsCtxt<'_, CTX, N>) -> Result {
...
fn broadcast<CTX: EthCheatCtx, N: Network>(
    ccx: &mut CheatsCtxt<'_, CTX, N>,
...
fn broadcast_key<CTX: EthCheatCtx, N: Network>(
    ccx: &mut CheatsCtxt<'_, CTX, N>,
    private_key: &U256,
    single_call: bool,
) -> Result {
