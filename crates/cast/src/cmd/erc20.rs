...
use foundry_cli::{
    ...
    utils::{LoadConfig, get_chain, get_foundry_provider},
};
use foundry_common::{
...
async fn get_foundry_provider_with_wallet(
    tx_opts: &SendTxOpts,
...
fn apply_tx_opts(tx: &mut FoundryTransactionRequest, tx_opts: &Erc20TxOpts, is_legacy: bool) {
