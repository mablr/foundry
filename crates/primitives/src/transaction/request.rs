use alloy_consensus::{BlobTransactionSidecar, BlobTransactionSidecarEip7594, EthereumTypedTransaction};
use alloy_network::{
    BuildResult, NetworkWallet, TransactionBuilder, TransactionBuilder4844, TransactionBuilder7702, TransactionBuilderError
};
use alloy_primitives::{Address, B256, ChainId, TxKind, U256};
use alloy_rpc_types::{AccessList, TransactionInputKind, TransactionRequest, SignedAuthorization};
...
impl alloy_network::TransactionBuilder7594 for FoundryTransactionRequest {
    ...
    fn set_max_fee_per_blob_gas(&mut self, max_fee_per_blob_gas: u128) {
        alloy_network::TransactionBuilder7594::set_max_fee_per_blob_gas(self.as_mut(), max_fee_per_blob_gas);
    }
