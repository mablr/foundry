...
fn inject_wallet<BLOCK: FoundryBlock>(state: &mut Cheatcodes<BLOCK>, wallet: LocalSigner<SigningKey>) -> Address {
...
fn create_wallet<BLOCK>(private_key: &U256, label: Option<&str>, state: &mut Cheatcodes<BLOCK>) -> Result {
...
fn sign_with_wallet<BLOCK: FoundryBlock>(
