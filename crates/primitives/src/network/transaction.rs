...
use alloy_network::{AnyNetwork, DynTransactionBuilder, Network, NetworkTransactionBuilder};
use alloy_primitives::{Address, B256, U256};
use alloy_rpc_types::{SignedAuthorization, TransactionRequest};
...
///
/// This extends the base [`DynTransactionBuilder`] trait with the same methods as
...
/// - [`FoundryTxRequest::max_fee_per_blob_gas`]
/// - [`FoundryTxRequest::set_max_fee_per_blob_gas`]
/// - [`FoundryTxRequest::blob_versioned_hashes`]
/// - [`FoundryTxRequest::set_blob_versioned_hashes`]
/// - [`FoundryTxRequest::blob_sidecar`]
/// - [`FoundryTxRequest::set_blob_sidecar`]
///
/// If the Network supports EIP-7702 authorization lists, implement these methods:
/// - [`FoundryTxRequest::authorization_list`]
/// - [`FoundryTxRequest::set_authorization_list`]
///
/// If the Network supports Tempo transactions, implement these methods:
/// - [`FoundryTxRequest::fee_token`]
/// - [`FoundryTxRequest::set_fee_token`]
/// - [`FoundryTxRequest::nonce_key`]
/// - [`FoundryTxRequest::set_nonce_key`]
pub trait FoundryTxRequest: DynTransactionBuilder + Debug {
    ...
    fn fee_token(&mut self) -> Option<Address> {
        None
    }
    ...
    fn nonce_key(&mut self) -> Option<U256> {
        None
    }
...
/// Foundry transaction request builder trait
///
/// This combines the base [`FoundryTxRequest`] trait with [`NetworkTransactionBuilder`] trait for
/// building transactions. It provides builder-pattern methods for setting transaction request
/// fields.
pub trait FoundryTxRequestBuilder<N: Network>:
    FoundryTxRequest + NetworkTransactionBuilder<N>
{
...
impl FoundryTxRequestBuilder<AnyNetwork> for <AnyNetwork as Network>::TransactionRequest {}
...
impl FoundryTxRequestBuilder<TempoNetwork> for <TempoNetwork as Network>::TransactionRequest {}
