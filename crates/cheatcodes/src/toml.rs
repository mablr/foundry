...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for keyExistsTomlCall {
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for parseToml_0Call {
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for parseToml_1Call {
    fn apply(&self, state: &mut Cheatcodes<CTX, N>) -> Result {
        let Self { toml, key } = self;
        parse_toml(
            toml,
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for parseTomlUintCall {
    fn apply(&self, _state: &mut Cheatcodes<CTX, N>) -> Result {
        let Self { toml, key } = self;
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for parseTomlUintArrayCall {
    fn apply(&self, _state: &mut Cheatcodes<CTX, N>) -> Result {
        let Self { toml, key } = self;
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for parseTomlIntCall {
    fn apply(&self, _state: &mut Cheatcodes<CTX, N>) -> Result {
        let Self { toml, key } = self;
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for parseTomlIntArrayCall {
    fn apply(&self, _state: &mut Cheatcodes<CTX, N>) -> Result {
        let Self { toml, key } = self;
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for parseTomlBoolCall {
    fn apply(&self, _state: &mut Cheatcodes<CTX, N>) -> Result {
        let Self { toml, key } = self;
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for parseTomlBoolArrayCall {
    fn apply(&self, _state: &mut Cheatcodes<CTX, N>) -> Result {
        let Self { toml, key } = self;
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for parseTomlAddressCall {
    fn apply(&self, _state: &mut Cheatcodes<CTX, N>) -> Result {
        let Self { toml, key } = self;
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for parseTomlAddressArrayCall {
    fn apply(&self, _state: &mut Cheatcodes<CTX, N>) -> Result {
        let Self { toml, key } = self;
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for parseTomlStringCall {
    fn apply(&self, _state: &mut Cheatcodes<CTX, N>) -> Result {
        let Self { toml, key } = self;
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for parseTomlStringArrayCall {
    fn apply(&self, _state: &mut Cheatcodes<CTX, N>) -> Result {
        let Self { toml, key } = self;
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for parseTomlBytesCall {
    fn apply(&self, _state: &mut Cheatcodes<CTX, N>) -> Result {
        let Self { toml, key } = self;
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for parseTomlBytesArrayCall {
    fn apply(&self, _state: &mut Cheatcodes<CTX, N>) -> Result {
        let Self { toml, key } = self;
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for parseTomlBytes32Call {
    fn apply(&self, _state: &mut Cheatcodes<CTX, N>) -> Result {
        let Self { toml, key } = self;
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for parseTomlBytes32ArrayCall {
    fn apply(&self, _state: &mut Cheatcodes<CTX, N>) -> Result {
        let Self { toml, key } = self;
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for parseTomlType_0Call {
    fn apply(&self, state: &mut Cheatcodes<CTX, N>) -> Result {
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for parseTomlType_1Call {
    fn apply(&self, state: &mut Cheatcodes<CTX, N>) -> Result {
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for parseTomlTypeArrayCall {
    fn apply(&self, state: &mut Cheatcodes<CTX, N>) -> Result {
        let Self { toml, key, typeDescription } = self;
        let ty = resolve_type(
            typeDescription,
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for parseTomlKeysCall {
    fn apply(&self, _state: &mut Cheatcodes<CTX, N>) -> Result {
        let Self { toml, key } = self;
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for writeToml_0Call {
    fn apply(&self, state: &mut Cheatcodes<CTX, N>) -> Result {
...
impl<CTX: EthCheatCtx, N: Network> Cheatcode<CTX, N> for writeToml_1Call {
    fn apply(&self, state: &mut Cheatcodes<CTX, N>) -> Result {
